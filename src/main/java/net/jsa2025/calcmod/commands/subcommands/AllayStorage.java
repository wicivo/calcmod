...
public class AllayStorage {
    ...
    public static String helpMessage = """
        §b§LКол-во эллеев для сортировки:§r§f
            При заданном количестве не стакабельных предметов в час §7§o(может быть представлено в виде выражения)§r§f, получаем нужное количество эллеев для сортировки.
