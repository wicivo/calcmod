...
public class ItemToStack {
    ...
    public static String helpMessage = """
        §b§LПредметы в кол-во стаков:§r§f
            При заданном количестве предметов §7§o(может быть представлено в виде выражения)§r§f, получаем количество стаков и остаток предметов.
            §eИспользование: /calc itemtostack <количество предметов>§f
                """;
}
