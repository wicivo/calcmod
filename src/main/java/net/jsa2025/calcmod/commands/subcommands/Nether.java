...
public class Nether {
    ...
    public static String helpMessage = """
        §b§LНижний мир:§r§f
            При заданной координате в верхнем мире, получаем соотвествующие координаты в нижнем мире. Если координаты не указаны, то команда принимает ваши текущии координаты.
